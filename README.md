...
видимым фрагментом соседней строки. Если две соседние строки не помещаются
одновременно с заданными ограничениями по высоте, crop-ratio и gap, генератор
оставляет одну из них вместо искусственного увеличения промежутков.
