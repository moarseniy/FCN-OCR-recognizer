...
- `synth_generators/line_generator/configs/example_001.yaml` — генерация;
- `configs/example_train_001.yaml` — обучение.
...
python -m synth_generators.line_generator.preview \
  --config synth_generators/line_generator/configs/example_001.yaml \
